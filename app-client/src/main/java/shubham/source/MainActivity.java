...
public class MainActivity extends Activity {
  ...
  private String                enteredPswd;
  private String                receiverPswd;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    pswdSubmit       = (Button)      findViewById(R.id.pswdSubmit);
    pswd             = (EditText)    findViewById(R.id.pswd);
    receiverPswd     = "shubham";
  ...
  private void reset_views() {
    ...
    pswdSubmit.setVisibility(View.GONE);
  }
  ...
  private void addSubmitClickHandler(){
    pswdSubmit.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        enteredPswd = pswd.getText().toString();
      }
    });
  ...
  private void showPswd(){
    ...
    pswdSubmit.setVisibility(View.VISIBLE);
    showConnectedReceiver();
  }

  private void openSocketToReceiver() throws Exception {
    // open socket connection
    if(enteredPswd==receiverPswd){
